...
import Img1 from '../../../Assets/img/signout.jpg';
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="text-center con-txt">Sign-up</h1>
                  ...
                  <div className='bodyLogin '>
                    <div class="mainLog ">
                      <form className='logFrom '>
                        <label className='labelLog' for="Log" aria-hidden="true">Sign up</label>
                        <span>Provide your valid Info</span>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input class="form-control" type="name" name='fist name' placeholder="First Name" id="basic-url" aria-describedby="basic-addon3" required="" />
                        </div>
                        <div className='logLabel2'>
                        ...
                        <div class="input-group mb-3">
                          <span class="input-group-text" id="basic-addon3"><i class="fa-solid fa-user"></i></span>
                          <input class="form-control" type="name" name='last name' placeholder="Last Name" id="basic-url" aria-describedby="basic-addon3" required="" />
                        </div>
                      ...
                      <NavLink
                        ...
                        to='/Signin'>
                        <span>Already have an account? <a style ={{color: '#282C34'}}>Login</a></span>
                      </NavLink>
                    </div>
                  </div>
